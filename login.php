...
<div class="row">
	<div class="col-md-3" id="login_splash">
				...
				<form method="post" action="index.php">
					...
					<div class="row">
						<div class="col-sm-offset-3 col-sm-6">
							<button name="signIn" type="submit" id="submit" value="signIn" class="btn btn-success btn-block"><?php echo $Translation['sign in']; ?></button>
						</div>
					</div>
				</form>
			</div>
